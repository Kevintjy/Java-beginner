 ...
 public class Transaction implements Serializable {
    ...
    public Transaction(String in, String out, double amount) {
        ...
        if ((this.transIn != null) && (this.transOut != null)) {
            ...
            this.transIn.pastTransaction.add(this);
            this.transOut.pastTransaction.add(this);
        }
    }
    ...
    @Override
     public String toString() {
        return "Transaction{" +
                "transIn=" + transIn.getAccountNum() +
                ", transOut=" + transOut.getAccountNum() +
                ", amount=" + amount +
                '}';
    }
}
